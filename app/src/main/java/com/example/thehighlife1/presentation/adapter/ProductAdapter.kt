...
import com.example.thehighlife1.presentation.activity.ProductDetailsActivity
import com.example.thehighlife1.data.model.Product
...
class ProductAdapter(private val productList: ArrayList<Product>, context: Context): RecyclerView.Adapter<ProductAdapter.ViewHolder>(){
    ...
    inner class ViewHolder(itemView: View):RecyclerView.ViewHolder(itemView){
        ...
        init {
            Log.d("ViewHolder", "itemView: $itemView")
            Log.d("ViewHolder", "productImage: $productImage_singleProduct")
            Log.d("ViewHolder", "productAddToFav: $productAddToFav_singleProduct")
            Log.d("ViewHolder", "productRating: $productRating_singleProduct")
            Log.d("ViewHolder", "productBrandName: $productBrandName_singleProduct")
            Log.d("ViewHolder", "discountTv: $discountTv_singleProduct")
            Log.d("ViewHolder", "productName: $productName_singleProduct")
            Log.d("ViewHolder", "productPrice: $productPrice_singleProduct")
            Log.d("ViewHolder", "discountLayout: $discount_singleProduct")
        }
